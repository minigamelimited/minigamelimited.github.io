(function () {
    ...
    var FBInstant = {
        setLoadingProgress(_val) {
            console.log("================>>> setLoadingProgress... " + Math.round(_val) + "%");
        },
        startGameAsync() {
    ...
    function boot() {
        ...
        var onStart = function () {
            ...
            if (fbProgressInterval >= 0) {
                clearInterval(fbProgressInterval);
                fbProgressInterval = -1;
                fbLoadProgress = 90;
            ...
            bundle.loadScene(launchScene,
                cc.sys.isBrowser ? function (completedCount, totalCount) {
                    var progress = 10 * completedCount / totalCount;
                    FBInstant.setLoadingProgress(progress + fbLoadProgress);
                } : null,
                function (err, scene) {
    ...
    if (window.document) {
        ...
        FBInstant.initializeAsync().then(function () {
            ...
            loadScript(debug ? 'cocos2d-js.js' : 'cocos2d-js-min.3ee81.js', function () {
                console.log("===============>>> load cocos2d-js-min complete.");
