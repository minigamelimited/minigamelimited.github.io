window.skins=window.skins||{};
	...
	function Main() {
		_super.call(this);
		this.skinParts = ["img_bee0","img_bee1","img_bee2","grp_addDesktop","grp_revisit","grp_start","img_love_ad","grp_love","rt_level","img_close","img_leftPage","grp_leftPage","img_rightPage","grp_rightPage","grp_levels","grp_main"];
	...
	_proto.grp_main_i = function () {
		...
		t.visible = true;
		t.width = 640;
		t.elementsContent = [this._Group1_i(),this.grp_addDesktop_i(),this.grp_revisit_i(),this.grp_start_i(),this.grp_love_i(),this.rt_level_i(),this.grp_levels_i()];
		return t;
	};
	...
	_proto.grp_love_i = function () {
		...
		t.visible = true;
		t.width = 300;
		t.elementsContent = [this._Image8_i(),this._Label4_i(),this._Image9_i(),this.img_love_ad_i()];
		return t;
	};
	...
	_proto.grp_levels_i = function () {
		...
		t.y = 266;
		t.elementsContent = [this._Image10_i(),this._Image11_i(),this._Label5_i(),this.img_close_i(),this.grp_leftPage_i(),this.grp_rightPage_i()];
		return t;
	};
